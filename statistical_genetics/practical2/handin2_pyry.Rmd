...
```
The chi-square test without continuity correction and the exact and permutation tests suggest that the variant rs587756191_T is in Hardy-Weinberg equilibrium. The chi-square test with continuity correction indicates a deviation, but this result may not be reliable due to the low genotype counts warning. Overall, considering the consistency of the other three tests, it seems likely that this variant is in Hardy-Weinberg equilibrium.
